    ...
    <main className="">
      ...
      >
        ...
        <RefreshIcon
          ...
          className="h-10 w-10 absolute right-3 top-24 text-blue-700 cursor-pointer hover:-rotate-180  transition-transform duration-300 ease-out active:scale-125"
        />
      </div>
      ...
      {blogs.length > 0 ? (
        ...
        <div className="flex flex-col justify-center items-center h-96 w-screen ">
          <h1 className="text-red-600 font-bold text-5xl font-Cursive  animate-bounce text-center">
